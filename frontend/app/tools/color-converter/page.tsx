        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-linear-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg shadow-green-500/25">
                <Palette className="w-7 h-7 text-white" />
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white bg-clip-text bg-linear-to-r from-green-400 to-emerald-300">Color Converter</h1>
              ...
              <div className="bg-slate-800/30 p-6 rounded-2xl border border-slate-700/50">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={handleHexConvert} className="px-4 py-2 bg-linear-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-xl">Convert</button>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={handleRgbConvert} className="px-4 py-2 bg-linear-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-xl">Convert</button>
                  </div>
                </div>
