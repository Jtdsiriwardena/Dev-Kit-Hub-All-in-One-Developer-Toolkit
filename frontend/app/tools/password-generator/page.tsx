        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-linear-to-br from-red-500 to-pink-600 rounded-xl flex items-center justify-center shadow-lg shadow-red-500/25">
                <Lock className="w-7 h-7 text-white" />
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white bg-clip-text bg-linear-to-r from-red-400 to-pink-300">
                  Password Generator
                </h1>
              ...
              <div className="bg-slate-800/30 p-6 rounded-2xl border border-slate-700/50">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-red-500 to-pink-600 text-white font-semibold rounded-xl shadow-lg"
                  >
                ...
                {password ? (
                  <div className="flex flex-col gap-4">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-linear-to-r from-red-500 to-pink-600 text-white font-semibold rounded-xl"
                    >
                      Copy to Clipboard
                    </button>
                  </div>
