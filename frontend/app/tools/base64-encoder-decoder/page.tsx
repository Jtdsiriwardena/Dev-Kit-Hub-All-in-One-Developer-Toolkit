        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-linear-to-br from-pink-500 to-rose-600 rounded-xl flex items-center justify-center shadow-lg shadow-pink-500/25">
                <Eye className="w-7 h-7 text-white" />
              </div>
              <div>
                <h1 className="text-3xl text-white font-bold bg-clip-text bg-linear-to-r from-pink-400 to-rose-300">
          ...
          <div className="grid gap-6 grid-cols-1 lg:grid-cols-3">
              ...
              <div className="bg-slate-800/30 p-6 rounded-2xl border border-slate-700/50">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-pink-500 to-rose-600 text-white font-semibold rounded-xl shadow-lg"
                  >
            ...
            {showPreview && (
              <div className="bg-slate-800/30 p-6 rounded-2xl border border-slate-700/50 flex flex-col">
                ...
                <div className="flex-1 overflow-auto font-mono text-white whitespace-pre-wrap wrap-break-word select-text">
                  {!output && !error && (
