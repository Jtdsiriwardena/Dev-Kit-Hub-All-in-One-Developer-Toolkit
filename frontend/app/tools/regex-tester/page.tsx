        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-linear-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/25">
                <Hash className="w-7 h-7 text-white" />
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white bg-linear-to-r from-white to-slate-300 bg-clip-text">Regex Tester</h1>
            ...
            <div className="space-y-6">
              <div className="bg-slate-800/30 p-6 rounded-2xl border border-slate-700/50">
                ...
                <div className="flex gap-4">
                  <button onClick={handleTest} className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-orange-500 to-red-600 text-white font-semibold rounded-xl shadow-lg">
