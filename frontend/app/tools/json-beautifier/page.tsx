...
export default function JsonBeautifier() {
  ...
  return (
    <div className="flex-1 overflow-auto">
            {/* Sidebar */}
            <Sidebar />
    <div className={`min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-6 ${isFullscreen ? 'fixed inset-0 z-50' : ''}`}>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-linear-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/25">
