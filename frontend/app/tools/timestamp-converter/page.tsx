        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-linear-to-br from-slate-500 to-gray-600 rounded-xl flex items-center justify-center shadow-lg shadow-slate-500/25">
                <Clock className="w-7 h-7 text-white" />
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white bg-clip-text bg-linear-to-r from-slate-400 to-gray-300">
                  Timestamp Converter
                </h1>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-linear-to-r from-slate-500 to-gray-600 text-white font-semibold rounded-xl"
                    >
                      To Date
                    </button>
                  </div>
